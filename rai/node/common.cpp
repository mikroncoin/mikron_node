...
{
	assert (block_type == rai::block_type::not_a_block || block_type == rai::block_type::send || block_type == rai::block_type::receive || block_type == rai::block_type::open || block_type == rai::block_type::state);
	header.serialize (stream_a);
