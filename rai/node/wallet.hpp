...
public:
	...
	std::shared_ptr<rai::block> add_comment_action (rai::account const &, rai::comment_block_subtype, std::string const &, bool = true);
	...
	void add_comment_async (rai::account const &, rai::comment_block_subtype, std::string const &, std::function<void(std::shared_ptr<rai::block>)> const &, bool = true);
