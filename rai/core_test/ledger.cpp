...
TEST (ledger_manna, balance_later)
{
	...
	int epoch_cutoff_time = 15638400; // should be rai::epoch::start::epoch2
...
TEST (ledger, send_self_invalid)
{
	...
	rai::state_block send_self (rai::genesis_account, genesis.hash (), epoch_cutoff_time + 100, rai::genesis_account, rai::genesis_amount - 100, rai::genesis_account, rai::test_genesis_key.prv, rai::test_genesis_key.pub, 0);
...
TEST (ledger, send_self_valid_legacy)
{
	...
	ASSERT_EQ (rai::process_result::progress, return1.code);
	// another send
	rai::state_block send_self2 (rai::genesis_account, send_self1.hash (), epoch_cutoff_time - 1000, rai::genesis_account, rai::genesis_amount - 200, rai::genesis_account, rai::test_genesis_key.prv, rai::test_genesis_key.pub, 0);
...
TEST (ledger, send_zero_invalid)
{
	...
	int epoch_cutoff_time = 15638400; // should be rai::epoch::start::epoch2
	rai::state_block send_zero_new (rai::genesis_account, genesis.hash (), epoch_cutoff_time + 100, rai::genesis_account, rai::genesis_amount, dest.pub, rai::test_genesis_key.prv, rai::test_genesis_key.pub, 0);
