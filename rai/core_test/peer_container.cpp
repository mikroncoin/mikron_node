...
TEST (peer_container, no_recontact)
{
	...
	ASSERT_FALSE (peers.insert (endpoint1, rai::protocol_information (), rai::account()));
	ASSERT_EQ (1, peers.size ());
	ASSERT_TRUE (peers.insert (endpoint1, rai::protocol_information (), rai::account()));
...
TEST (peer_container, no_self_incoming)
{
	...
	peers.insert (self, rai::protocol_information (), rai::account());
...
{
	rai::peer_container peers (rai::endpoint{});
	ASSERT_TRUE (peers.insert (rai::endpoint (boost::asio::ip::address_v6::v4_mapped (boost::asio::ip::address_v4 (0x00000001)), 10000), rai::protocol_information (), rai::account()));
	ASSERT_TRUE (peers.insert (rai::endpoint (boost::asio::ip::address_v6::v4_mapped (boost::asio::ip::address_v4 (0xc0000201)), 10000), rai::protocol_information (), rai::account()));
	ASSERT_TRUE (peers.insert (rai::endpoint (boost::asio::ip::address_v6::v4_mapped (boost::asio::ip::address_v4 (0xc6336401)), 10000), rai::protocol_information (), rai::account()));
	ASSERT_TRUE (peers.insert (rai::endpoint (boost::asio::ip::address_v6::v4_mapped (boost::asio::ip::address_v4 (0xcb007101)), 10000), rai::protocol_information (), rai::account()));
	ASSERT_TRUE (peers.insert (rai::endpoint (boost::asio::ip::address_v6::v4_mapped (boost::asio::ip::address_v4 (0xe9fc0001)), 10000), rai::protocol_information (), rai::account()));
	ASSERT_TRUE (peers.insert (rai::endpoint (boost::asio::ip::address_v6::v4_mapped (boost::asio::ip::address_v4 (0xf0000001)), 10000), rai::protocol_information (), rai::account()));
	ASSERT_TRUE (peers.insert (rai::endpoint (boost::asio::ip::address_v6::v4_mapped (boost::asio::ip::address_v4 (0xffffffff)), 10000), rai::protocol_information (), rai::account()));
	ASSERT_EQ (0, peers.size ());
}
...
TEST (peer_container, fill_random_full)
{
	...
	{
		peers.insert (rai::endpoint (boost::asio::ip::address_v6::loopback (), i), rai::protocol_information (), rai::account());
	}
	std::array<rai::endpoint, 8> target;
	std::fill (target.begin (), target.end (), rai::endpoint (boost::asio::ip::address_v6::loopback (), 10000));
	peers.random_fill (target);
...
TEST (peer_container, fill_random_part)
{
	...
	{
		peers.insert (rai::endpoint (boost::asio::ip::address_v6::loopback (), i + 1), rai::protocol_information (), rai::account());
	}
	std::fill (target.begin (), target.end (), rai::endpoint (boost::asio::ip::address_v6::loopback (), 10000));
	peers.random_fill (target);
...
// Not relevant after protocol version reset, legacy peer handling (legacy protocol version)
...
TEST (peer_container, list_fanout)
{
	...
	{
		ASSERT_FALSE (peers.insert (rai::endpoint (boost::asio::ip::address_v6::loopback (), 10000 + i), rai::protocol_information (), rai::account()));
	}
...
{
	rai::peer_container peers (rai::endpoint{});
	peers.insert (rai::endpoint (boost::asio::ip::address_v6::loopback (), 24001), rai::protocol_information (), rai::account());
	...
	peers.insert (endpoint2, rai::protocol_information (), rai::account());
	peers.insert (endpoint0, rai::protocol_information (), rai::account());
	peers.insert (endpoint1, rai::protocol_information (), rai::account());
	rai::keypair keypair;
