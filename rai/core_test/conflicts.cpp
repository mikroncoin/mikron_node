...
TEST (conflicts, start_stop)
{
	...
	rai::genesis genesis;
	rai::keypair key1;
	auto send1 (std::make_shared<rai::state_block> (rai::test_genesis_key.pub, genesis.hash (), key1.pub, 0, key1.pub, rai::test_genesis_key.prv, rai::test_genesis_key.pub, 0));
...
TEST (conflicts, add_two)
{
	...
	rai::genesis genesis;
	rai::keypair key1;
	auto send1 (std::make_shared<rai::state_block> (rai::test_genesis_key.pub, genesis.hash (), key1.pub, 100, key1.pub, rai::test_genesis_key.prv, rai::test_genesis_key.pub, 0));
	ASSERT_EQ (rai::process_result::progress, node1.process (*send1).code);
	auto node_l (system.nodes[0]);
	node1.active.start (send1);
	rai::keypair key2;
	auto state_send2 (std::make_shared<rai::state_block> (rai::test_genesis_key.pub, send1->hash (), key2.pub, 0, key2.pub, rai::test_genesis_key.prv, rai::test_genesis_key.pub, 0));
