...
typedef unsigned char * xrb_uint64;  //  8byte array for amounts
...
// Convert amount bytes 'source' to a 20 byte not-null-terminated decimal string 'destination'
void xrb_uint64_to_dec (const xrb_uint64 source, char * destination);
...
// Convert 20 digit decimal string 'source' to a byte array 'destination'
