...
// found in secure.cpp
const GENESIS_ACCOUNT: &str = "mik_37qjexk5phhd9fin11z68dsmsmxirhm6isptm8pdb39kp6z5w8e1534tigqk";
    ...
    let matches = clap::App::new("raiblocks-load-tester")
        ...
        .arg(
            Arg::with_name("tmp_dir")
                .long("tmp-dir")
                .value_name("PATH")
                .help("The path to a temporary directory for mikron_node data"),
        )
        .arg(
            Arg::with_name("node_path")
                .value_name("PATH")
                .required(true)
                .help("The path to the mikron_node to test"),
        )
        .arg(
